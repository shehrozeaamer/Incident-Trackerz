        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin">
               ...
               <div class="form-label-group">
                <input type="text" id="cell" class="form-control" placeholder="Email address" required autofocus>
              ...
              <?php if(isset($error)){echo "<button class='btn btn-danger'>".@$error."</button>";} ?>
